...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceLojaRoupa.Model.CartaoCredito", b =>
                {
                    b.HasOne("EcommerceLojaRoupa.Model.Bandeira", null)
                        .WithOne("CartaoCredito")
                        .HasForeignKey("EcommerceLojaRoupa.Model.CartaoCredito", "BandeiraId")
            ...
            modelBuilder.Entity("EcommerceLojaRoupa.Model.ItemCarrinho", b =>
                {
                    b.HasOne("EcommerceLojaRoupa.Model.Roupa", null)
                        .WithOne("ItemCarrinho")
                        .HasForeignKey("EcommerceLojaRoupa.Model.ItemCarrinho", "RoupaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
